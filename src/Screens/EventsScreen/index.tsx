...
const EventsScreen = () => {
  const musicEventDetails: CardDetailsProps[] = [
    ...
    },
    {
      ...
      eventDetail:
        'Lorem ipsum dot consectetur, adipisicing elit. Illum ab, debitis blanditiis similique id deleniti atque aut impedit nihil. Officiis ipsam minus laboriosam sint! Optio, quis, animi odit quo quibusdam fugiat tempore quia ipsum, deleniti expedita itaque. Ea animi debitis voluptatibus quod repellendus repudiandae neque! At animi dolores ipsa consequatur.',
    },
    {
      eventName: 'Battle Of Bands',
      eventDetail:
        'Lorem ipsum dolor sit amet consectetur, adipisicing elllum ab, debitis blanditiis similique id deleniti atque aut impedit nihil. Officiis ipsam minus laboriosam sint! Optio, quis, animi odit quo quibusdam fugiat tempore quia ipsum, deleniti expedita itaque. Ea animi debitis voluptatibus quod repellendus repudiandae neque! At animi dolores ipsa consequatur.',
    },
  ];
