...
const REGISTER_DOCS_LINK = 'https://docs.google.com/forms/d/e/1FAIpQLSckO1HrYoCpGbA8GFhly2Ixqz5FqVKQqZjKFjc3wKzVIi4oGA/viewform?usp=sf_link';
const details = [
    'Music',
    'Drama',
    'Art & Craft',
    ...
    return (
        <Box p={10} pt={15} pl={isDeviceSm ? 5 : 30} pr={isDeviceSm ? 5 : 30} className={classes.background} textAlign="center" style={{textAlignLast: '-webkit-center' as any}}>
           <Box>
                ...
                <Typo variant="body2">
                    Click on the society to see their events.   
                </Typo> 
            </Box>
            <Box pt={6}>
            ...
            <Box display="flex" flexDirection="row" justifyContent='space-around' pt={5} style={{textAlign: '-webkit-center' as any}}>
                {/* <Box width="100%">
                    <Button variant='outlined' color='primary'>See Event Schedule</Button>
                </Box> */}
                <a href={REGISTER_DOCS_LINK} rel="noopener noreferrer" target='_blank' style={{textDecoration: 'none'}}>
                    <Box width="100%">
                        <Button variant='outlined' color='primary'>Register For Cultural Events</Button>
                    </Box>
                </a>
            </Box>
            </Box>
